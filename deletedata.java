...
public class deletedata extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/darshan", "root", "");
           PreparedStatement stmt = (PreparedStatement) conn.prepareStatement("DELETE FROM student WHERE roll_no = ?");
           stmt.setInt(1, Integer.parseInt(request.getParameter("roll")));
